...
def launch_eval_exp14_10_24_18(name):
    rungroup = 'merged-exp14-dim-vs-prec-large-scale'
    evaltypes = ['QA','intrinsics']
    embs = evaluate.get_all_embs_in_rg(rungroup)
    configs = []
    for evaltype in evaltypes:
...
def launch_eval_exp13_10_24_18(name):
    rungroup = 'merged-exp13-large-scale-glove6B'
