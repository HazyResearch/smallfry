...
cmd="sudo docker run --runtime=nvidia -v /proj:/proj -i --rm tensorflow/tensorflow:latest-gpu-py3 /bin/bash -c \"apt-get --assume-yes update; apt-get --assume-yes install git-core; $1\""
