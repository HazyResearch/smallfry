...
First, we observe that the simple uniform quantization method performs \todo{very similarly} to the deep dictionary learning (DCCL) and k-means compression methods across a number of tasks, embedding types, and compression ratios.
...
For example, the uniform quantization method can have \todo{significantly worse} PIP loss than DCCL while attaining \todo{similar downstream performance}.
...
%		\includegraphics[width=.245\linewidth]{figures/glove-wiki400k-am_intrinsics_google-mul_vs_compression_linx_det.pdf} &
%		\includegraphics[width=.245\linewidth]{figures/glove-wiki400k-am_intrinsics_bruni_men_vs_compression_linx_det.pdf} \\
...
%		\includegraphics[width=.245\linewidth]{figures/glove-wiki400k-am_intrinsics_analogy-avg-score_vs_compression_linx_det_uni-quant-only.pdf} &
%		\includegraphics[width=.245\linewidth]{figures/glove-wiki400k-am_intrinsics_similarity-avg-score_vs_compression_linx_det_uni-quant-only.pdf} \\
