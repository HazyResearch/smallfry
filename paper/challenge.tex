...
(1) Dimensionality reduction methods perform very poorly relative to the other compression methods;
(2) The simpler compression methods (k-means, uniform quantization) perform on par with the more elaborate DCCL compression method.
