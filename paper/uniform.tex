...
\label{subsec:gen_perf}
	\begin{itemize}
		...
		\item Theory validation
			\begin{itemize}
				\item Exp1: overlap vs dimensionality for different precision. Expectation: overlap increases with dimensionality.
 				\item Exp 2: overlap vs precision for different dimensionality. Expectation: overlap increases with higher precision.
			\end{itemize}
