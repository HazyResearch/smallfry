...
In particular, one can simply train an embedding with a lower dimension, or using a dimensionality reduction method like principal component analysis (PCA).
In this work, we evaluate the performance of full-precision embeddings trained at lower dimensions, relative to the higher dimensional embeddings compressed using the above methods.
