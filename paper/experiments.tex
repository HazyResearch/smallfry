\begin{itemize}
\item Claim1: Uniform quantization matches the performance of complex methods. \todo{(confirm which experiment data point we can put here.)}
	\begin{itemize}
	...
	\end{itemize}
\item Claim 2: Subspace overlap characterize compressed embedding on downstream task performance. \todo{(confirm which experiment data point we can put here.)}
	\begin{itemize}
