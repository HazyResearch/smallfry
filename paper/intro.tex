...
these methods build on drastically different machineries, ranging from dictionary learning \citep{sparse16,dccl17,kway18} using neural networks to simple fixed point quantization \citep{andrews16,lam2018word2bits}. %\todo{more concise?}
